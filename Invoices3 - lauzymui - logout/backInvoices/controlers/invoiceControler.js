const {createInvoice, getInvoiceByinvoice_code, generateUniqueCode, getAllInvoices, updateInvoice, deleteInvoice, filterInvoices } = require('../models/invoiceModel');
...
exports.getInvoiceByinvoice_code = async (req, res, next) => {
  ...
  exports.getFilteredInvoices = async (req, res, next) => {
    try {
      ...
      // If no query string, return all invoices
