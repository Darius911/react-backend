...
export default function StarsRating() {
  ...
  return (
    <section className="flex flex-col h-screen">
      <Header />
      <Navigation />
      <div className="flex  md:flex-row sm:flex-row  gap-4 items-center justify-center  max-w-3xl mx-auto   py-2 mb-4 rounded-lg shadow-md  border-box min-h-85 h-screen">
